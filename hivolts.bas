...
240 IF T = 1 THEN GOSUB 5700
250 IF T = 0 THEN GOSUB 8000
260 GOSUB 8900
270 GOSUB 5580
280 GOSUB 9000
290 GOTO 220
...
8090 LET P(I,1) = P(I, 1) + 1
8100 IF P(I,2) < P(13,2) THEN LET P(I,2) = P(I,2) + 1 : GOTO 8060
8110 IF P(I,2) > P(13,2) THEN LET P(I,2) = P(I,2) - 1 : GOTO 8060
8120 GOTO 8060

8130 LET P(I,1) = P(I, 1) - 1
8140 IF P(I,2) < P(13,2) THEN LET P(I,2) = P(I,2) + 1 : GOTO 8060
8150 IF P(I,2) > P(13,2) THEN LET P(I,2) = P(I,2) - 1 : GOTO 8060
8160 GOTO 8060
