...
# intro screen
300 CLS
310 PRINT AT 0, 13;"HIVOLTS"
320 PRINT AT 1, 4;"SHOW INSTRUCTIONS? (Y/N)"
330 LET A$ = INKEY$
340 IF A$ = "" THEN GOTO 330
350 IF A$ = "Y" OR A$ = "y" THEN GOTO 9700
360 IF A$ = "N" OR A$ = "n" THEN GOTO 400
370 GOTO 130

# main
400 GOSUB 5000
410 GOSUB 5500
420 IF V <> 0 THEN GOTO 9500
430 IF T = 1 THEN GOSUB 5700
440 IF T = 0 THEN GOSUB 8000
450 GOSUB 8890
460 GOSUB 5580
470 GOSUB 9000
480 GOTO 420
...
5540 IF B(I,J) = 1 THEN PRINT INK 0; AT I + 5,J + 9;"\a"
5550 NEXT J
5560 NEXT I
5580 FOR I = 1 TO 12
5590 IF P(I,1) <> 0 AND P(I,2) <> 0 THEN PRINT BRIGHT 1; INK 1; AT P(I,1) + 5,P(I,2) + 9;"\b"
5600 NEXT I
5610 IF P(13,1) <> 0 AND P(13,2) <> 0 THEN PRINT BRIGHT 1; INK 2; AT P(13,1) + 5,P(13,2) + 9;"\c"
5620 RETURN
...
8310 NEXT J
8320 FOR J = 1 TO 3
8330 IF B(D(J,1),D(J,2)) = 1 THEN LET P(I,1) = D(J,1) : LET P(I,2) = D(J,2) : GOTO 8060
8340 NEXT J
8350 GOTO 8060

# check collisions
8890 FOR I = 1 TO 12
8900 IF P(I,1) = 0  AND P(I,2) = 0 THEN GOTO 8970
8910 IF B(P(I,1),P(I,2)) = 1 THEN LET P(I,1) = 0 : LET P(I,2) = 0 : GOTO 8970
8920 FOR J = I TO 13
8930 IF I = J THEN GOTO 8960
8940 IF P(J,1) = 0  AND P(J,2) = 0 THEN GOTO 8960
8950 IF P(I,1) = P(J,1) AND P(I,2) = P(J,2) THEN LET P(I,1) = 0 : LET P(I,2) = 0 : LET P(J,1) = 0 : LET P(J,2) = 0
8960 NEXT J
8970 NEXT I
8980 IF P(13,1) <> 0 AND P(13,2) <> 0 AND B(P(13,1),P(13,2)) = 1 THEN LET P(13,1) = 0 : LET P(13,2) = 0
8990 RETURN
...
9630 IF A$ = "Y" OR A$ = "y" THEN GOTO 400
9640 IF A$ = "N" OR A$ = "n" THEN GOTO 500
9650 GOTO 9600

# instructions
9700 CLS
9710 PRINT AT 0,10; "INSTRUCTIONS"
9720 PRINT AT 2,0; "YOU (";BRIGHT 1;INK 2;"\c";BRIGHT 0;INK 0;") ARE BEING CHASED BY THE "
9730 PRINT AT 3,0; "EVIL MHOS (";BRIGHT 1; INK 1;"\b";BRIGHT 0; INK 0;") IF THEY LAND ON"
9740 PRINT AT 4,0; "YOU, YOU WILL DIE. IF YOU TOUCH"
9750 PRINT AT 5,0; "AN ELECTRIC FENCE (\a) YOU WILL"
...
9930 GOTO 400
9950 DATA BIN 10000001,BIN 10000001,BIN 10101011,BIN 11010101,BIN 10101011,BIN 11010101,BIN 10000001,BIN 10000001
9960 DATA BIN 00111100,BIN 01111110,BIN 11011011,BIN 11111111,BIN 11000011,BIN 01111110,BIN 01011010,BIN 11000011
9970 DATA BIN 00011000,BIN 00011000,BIN 00111100,BIN 00110010,BIN 01010010,BIN 01010010,BIN 00011000,BIN 00100100
